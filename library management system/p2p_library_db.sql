...
INSERT INTO `lib_member_master` (`mem_name`,`mem_address`,`mem_email_id`,`mem_mobile_no`,`mem_registered_date`,`mem_active`) VALUES 
 ('Chirayu','Hapur','chirayuk2014@gmail.com','8755167688','2024-01-24','Y'),
 ('Khushi','Noida, India','khushi123@yahoo.com','9999999999','2023-02-02','Y'),
 ('Nikhil','New Delhi','nikhil.kansal@gmail.com','9999632333','2023-12-23','Y');
/*!40000 ALTER TABLE `lib_member_master` ENABLE KEYS */;

select*from lib_transaction;
update lib_member_master
set mem_id = 3
where mem_id = 6;
--
...
INSERT INTO `lib_user` (`user_name`,`user_password`,`user_type`,`user_active`) VALUES 
 ('Chirayu','124','Admin','YES'),
 ('Priyanshu','123','User','YES'),
 ('Nikhil','nik123','User','YES');
...
delete from lib_user where user_name = ('Atanu', 'd', 'Raj', 'sanjay');
